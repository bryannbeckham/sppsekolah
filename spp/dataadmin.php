...
<a class="btn btn-success " href="tambahAD.php">TAMBAH DATA</a>
<?php
	?>
 	...
 	while($dta = mysqli_fetch_assoc($data) ):
 	 ...
 	 <tr>
 	 	...
 	 	<td width="160px">
 	 		...
 	 		<a class="btn btn-info btn-sm" href="hapusAD.php?id=<?= $dta['idadmin'] ?>" onclick ="return confirm('apakah anda yakin ingin menghapus data admin? ')">HAPUS</a>
 	 	</td>
 	 </tr>
 	 <?php $i++;  ?>
 	<?php endwhile; ?>
